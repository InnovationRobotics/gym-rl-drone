...
def train(num_timesteps, train_model):

    global best_model_path, last_model_path

    best_model_path = '/home/graphics/gym_px4/model_dir/model_'+str('test')+'_best'
    last_model_path = '/home/graphics/gym_px4/model_dir/model_'+str('test')+'_last'
    ...
    pi, oldpi, loss_names, var_list, lossandgrad, adam, assign_old_eq_new, compute_losses, mpi_moments_fn, allgather_fn = policy_init(ob_space=ob_space,ac_space=ac_space, policy_fn = policy_fn, clip_param = clip_param, entcoeff = entcoeff, adam_epsilon = adam_epsilon)
